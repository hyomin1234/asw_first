#!/usr/bin/env python3
"""
각도 필터링이 적용된 SLLIDAR A1 런치 파일
원하는 각도 범위만 수집할 수 있습니다.
"""
...
def generate_launch_description():
    ...
    range_max = LaunchConfiguration('range_max', default='100.0')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='최소 각도 (도 단위, 예: 0)'),
        
        DeclareLaunchArgument(
            'angle_max_deg',
            default_value=angle_max_deg,
            description='최대 각도 (도 단위, 예: 180)'),
